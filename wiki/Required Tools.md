...
4. Text Editor. I prefer [VSCodium](https://vscodium.com/), but you may use any other text editor that supports syntax highlighting. Other contestants are sublime and Notepad++. The advantage of VSCodium is that it can open the entire LUA folder in an overview for quick jumps between files. It's kind of more like an IDE. There are also GLua addons available for it that add syntax highlighting for Gmod Lua,as well as glualinter which does formatting automatically on top of reporting errors or bad coding practices.
